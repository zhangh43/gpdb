...
CREATE TYPE vint2 ( INPUT = vint2in, OUTPUT = vint2out, storage = plain, internallength = 2,PASSEDBYVALUE );
...
CREATE TYPE vint4 ( INPUT = vint4in, OUTPUT = vint4out, storage = plain, internallength = 4,PASSEDBYVALUE );
...
CREATE TYPE vint8 ( INPUT = vint8in, OUTPUT = vint8out, storage = plain, internallength = 8,PASSEDBYVALUE);
...
CREATE TYPE vfloat4 ( INPUT = vfloat4in, OUTPUT = vfloat4out, storage = plain, internallength = 4,PASSEDBYVALUE );
...
CREATE TYPE vfloat8 ( INPUT = vfloat8in, OUTPUT = vfloat8out, storage = plain, internallength = 8,PASSEDBYVALUE );
