 ...
 * resume threshold, the sender continue to read data from the backend.
 *
...
ic_proxy_client_on_c2p_data_pkt(void *opaque, const void *data, uint16 size)
{
	...
	/* got a c2p packet, but have not received the heartbeat ack yet */
	client->unackSendPkt++;
	 ...
	 * continue to read from the backend again.
	 */
